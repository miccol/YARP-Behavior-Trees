...
enum NodeModel {PARALLEL, SELECTOR, SEQUENCE, SEQUENCESTAR, SELECTORSTAR, LUAACTION, PYTHONACTION, LUACONDITION,  YARPACTION, YARPCONDITION, DECORATOR, ROOT, SUBTREE};
