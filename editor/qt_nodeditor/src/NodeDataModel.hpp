...
enum NodeModel {PARALLEL, SELECTOR, SEQUENCE, SEQUENCESTAR, SELECTORSTAR, LUAACTION, PTYHONACTION, LUACONDITION,  YARPACTION, YARPCONDITION, DECORATOR, ROOT, SUBTREE};
