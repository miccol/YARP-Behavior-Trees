...
enum NodeModel {PARALLEL, SELECTOR, SEQUENCE, SEQUENCESTAR, SELECTORSTAR, LUAACTION, PYTHONACTION, PYTHONCONDITION, LUACONDITION,  YARPACTION, YARPCONDITION, DECORATOR, ROOT, SUBTREE};
