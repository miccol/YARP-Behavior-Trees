#ifndef LUANODEMODEL_H
#define LUANODEMODEL_H
...
class LuaNodeModel : public BehaviorTreeNodeModel
{
  Q_OBJECT
public:
  LuaNodeModel(QString name, const NodeFactory::ParametersModel& parameter_model);

  virtual ~LuaNodeModel() {}
