#ifndef YARPNodeModel_H
#define YARPNodeModel_H
...
class YARPNodeModel : public BehaviorTreeNodeModel
{
  Q_OBJECT
public:
  YARPNodeModel(QString name, const NodeFactory::ParametersModel& parameter_model);

  virtual ~YARPNodeModel() {}
