...
{
  public:
    ConditionNodeModel() : BehaviorTreeNodeModel("Condition", NodeFactory::get().getActionParameterModel())
    {
    }
    int BTType()
    {
...
class PythonConditionNodeModel : public PythonNodeModel
{
  public:
    PythonConditionNodeModel() : PythonNodeModel("Condition", NodeFactory::get().getActionParameterModel())
    {
    }
    int BTType()
    {
        return QtNodes::PYTHONCONDITION;
    }
    virtual ~PythonConditionNodeModel() {}
    ...
    virtual std::unique_ptr<NodeDataModel> clone() const override
    {
        return std::unique_ptr<NodeDataModel>(new PythonConditionNodeModel);
    }

    virtual QString name() const override { return QString("PythonCondition"); }
};

class YARPConditionNodeModel : public YARPNodeModel
{
  public:
    YARPConditionNodeModel() : YARPNodeModel("YARP Condition", NodeFactory::get().getActionParameterModel())
    {
    }
    int BTType()
    {
